	...
	; Compiler options:
	;
	; -oICH R2ULBL 02.cof -mICH R2ULBL 02.map --summary=default \
	; --output=default main.p1 mComm.p1 mComm_custom.p1 mComm_opcodes.p1 \
	; mTouch.p1 mTouch_acquisition.p1 mTouch_acquisition_HCVD.p1 \
	; mTouch_eeprom.p1 mTouch_proximity.p1 mTouch_slider.p1 ICH-LR-HR.p1 \
	; --chip=16F1933 -P --runtime=default \
